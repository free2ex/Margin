...
/**
* @title Free2ex stablecoin smart contract
* @author Free2ex
* The smart contract realizes stablecoin functionality
*/
...
abstract contract StandardToken is BasicToken, ERC20 {
   ...
   * return allowed A uint specifying the amount of tokens still available for the spender.
   */
...
abstract contract BlackList is Ownable, BasicToken {
   ...
   /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded F2X) ///////
...
contract F2XAsset is Pausable, StandardToken, BlackList {
